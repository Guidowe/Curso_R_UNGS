---
title: "Introducción a R. Aplicación práctica en la EPH"
...
Esta función está dentro del paquete tidyverse. Nos permite seleccionar una muestra al azar de *n* casos de nuestra base de datos. Puede ser útil para una primera mirada de la base que trascienda a los primeros casos, o bien para procedimienos de muestreo aleatorio.    
```{r}
...
Más adelante en el curso veremos una implementación del *paquete eph* que extiende las potencialidades de esta función, permitiendo hacer tabulados con ponderadores, calcular las distribuciones porcentuales, entre otras.
